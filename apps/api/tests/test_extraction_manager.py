...
async def test_local_success_skips_apis():
    ...
    mock_local.extract.return_value = ExtractionResult(
        ...
        url=url,
        title="Local Title",
        content="Local extractor output. Officials confirmed on Tuesday that the new measures will take effect next month. The announcement followed weeks of negotiation between the two sides. Analysts said the agreement was broader than expected and would affect several sectors. A spokesperson said further details would be published in the coming days. Local businesses welcomed the decision, though some raised concerns about the timeline. The department said it would review the policy again after six months.",
        author=None,
        image_url=None,
        published_at=None,
...
async def test_tavily_failure_falls_back_to_firecrawl():
    ...
    mock_firecrawl.extract.return_value = ExtractionResult(
        ...
        content="Firecrawl fallback output. Officials confirmed on Tuesday that the new measures will take effect next month. The announcement followed weeks of negotiation between the two sides. Analysts said the agreement was broader than expected and would affect several sectors. A spokesperson said further details would be published in the coming days. Local businesses welcomed the decision, though some raised concerns about the timeline. The department said it would review the policy again after six months.",
        author=None,
        image_url=None,
        published_at=None,
        diagnostics=ExtractionDiagnostics(
...
async def test_idempotency_cache():
    ...
    cached_result = ExtractionResult(
        ...
        url=url,
        title="Cached Title",
        content="Cached output. Officials confirmed on Tuesday that the new measures will take effect next month. The announcement followed weeks of negotiation between the two sides. Analysts said the agreement was broader than expected and would affect several sectors. A spokesperson said further details would be published in the coming days. Local businesses welcomed the decision, though some raised concerns about the timeline. The department said it would review the policy again after six months.",
        author=None,
        image_url=None,
        published_at=None,
        diagnostics=ExtractionDiagnostics(
