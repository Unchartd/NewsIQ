...
def upgrade() -> None:
    ...
    op.add_column(
        "prompt_versions", sa.Column("schema_version", sa.String(length=50), nullable=True)
    )
    op.add_column(
        "prompt_versions", sa.Column("preferred_model", sa.String(length=100), nullable=True)
    )
    op.add_column(
        "prompt_versions",
        sa.Column(
            "lifecycle_state", sa.String(length=50), nullable=True, server_default="production"
        ),
    )
    ...
    op.add_column(
        "prompt_versions", sa.Column("superseded_by", sa.String(length=255), nullable=True)
    )
