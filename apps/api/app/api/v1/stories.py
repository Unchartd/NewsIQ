...
async def get_story_detail(
    ...
    # Increment the view counter directly (cheap UPDATE, keeps metrics accurate on cache hits)
    await db.execute(
    ...
    # Cache the serialized payload (mode='json' makes UUIDs/datetimes JSON-safe)
