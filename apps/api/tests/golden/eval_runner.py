    ...
    if is_live:
        ...
        simulated_responses = {
            "tech_acquisition": StorySummaryResponse(
                ...
                key_facts=["TechCorp is acquiring startup InnovateAI.", "The cash transaction is valued at $500M."],
                category="technology"
            ),
            "natural_disaster": StorySummaryResponse(
                ...
                key_facts=["Hurricane Helene made landfall in Florida.", "Maximum winds reached 140 mph in Category 4 storm."],
                category="weather"
            ),
            "financial_policy": StorySummaryResponse(
                ...
                key_facts=["Federal Reserve raises benchmark interest rate by 25 bps.", "The decision aims to return inflation to 2% target."],
                category="business"
            ),
            "space_discovery": StorySummaryResponse(
                ...
                key_facts=["Webb telescope confirms rocky exoplanet LHS 475 b.", "LHS 475 b orbits its star in two days."],
                category="science"
            ),
            "sports_championship": StorySummaryResponse(
                ...
                key_facts=["Argentina wins World Cup title.", "Lionel Messi scored twice and won shootout."],
                category="sports"
            )
        }
        ...
        mock_summary_res = simulated_responses.get(
            ...
            StorySummaryResponse(
                ...
                key_facts=[f"Fact 1: {description} was finalized.", "Fact 2: High interest in this industry."],
