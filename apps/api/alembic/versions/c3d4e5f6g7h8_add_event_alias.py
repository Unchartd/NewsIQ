...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_event_aliases_canonical_event_id'), 'event_aliases', ['canonical_event_id'], unique=False)

    op.add_column('stories', sa.Column('canonical_event_slug', sa.String(length=255), nullable=True))
